...
def ss_average_max():
  ...
  max_sales = col3.number_input("Specify Max Sales per day", value=st.session_state["max_demand"])
  avg_sales = col4.number_input("Specify Average Sales per day", value=st.session_state["avg_demand"])
